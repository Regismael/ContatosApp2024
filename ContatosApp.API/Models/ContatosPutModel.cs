...
{
    public class ContatosPutModel
    {
        [Required(ErrorMessage ="Informe o ID do cliente desejado.")]
        ...
        [RegularExpression(@"\(\d{2}\)\s\d{5}-\d{4}", ErrorMessage = "Por favor, informe um telefone\r\nno formato: '(99) 99999-9999'.   ")]
